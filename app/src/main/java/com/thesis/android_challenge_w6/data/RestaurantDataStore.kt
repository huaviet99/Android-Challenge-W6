package com.thesis.android_challenge_w6.data

import com.thesis.android_challenge_w6.model.Restaurant

object RestaurantDataStore {
    private val favoriteRestaurantMap = HashMap<String,MutableList<Restaurant>>()

    private val defaultRestaurantList = listOf(
        Restaurant("Du Miên Garden Cage - Phan Văn Trị","7 Phan Văn Trị, P. 10","https://images.foody.vn/res/g4/33760/prof/s180x180/foody-mobile-du-mien-garden-mb-jp-309-635785114907746480.jpg"),
    ...
    fun getFavoriteRestaurantList(email: String):List<Restaurant>{
        val restaurantList = favoriteRestaurantMap[email]
        return restaurantList?.toList() ?: emptyList()
    }
